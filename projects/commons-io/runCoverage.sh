...
alias jsr='java -Xmx16g -jar ~/workspace/master-jsr/jsr/JSR-CLI/build/libs/JSR-CLI-1.0-SNAPSHOT.jar'

PROJECT_NAME="commons-io"
TEST_DIR="./src/test/java/"
SRC_DIR="./src/main/java"
CLASS_DIR="target/classes"
JAR_DIR=target/commons-io-2.6-fat-tests.jar
SLICER_DIR="/home/lukas/workspace/master-jsr/slicer/Slicer4J"
PACKAGE="org.apache.commons.io"
BASE_OUT_DIR="/home/lukas/workspace/master-benchmark/results/commons-io"
