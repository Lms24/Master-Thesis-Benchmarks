...
public class CleanerTest {
    ...
    public void whitelistedProtocolShouldBeRetained() {
        Whitelist whitelist = Whitelist.none().addTags("a").addAttributes("a", "href").addProtocols("a", "href", "something");
    ...
    public void handlesAllPseudoTag() {
        ...
        Whitelist whitelist = new Whitelist().addAttributes(":all", "class").addAttributes("p", "style").addTags("p", "a");
    ...
    public void handlesNestedQuotesInAttribute() {
        ...
        Whitelist allow = Whitelist.relaxed().addAttributes("div", "style");
