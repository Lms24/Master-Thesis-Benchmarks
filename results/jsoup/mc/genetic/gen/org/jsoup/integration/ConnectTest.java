...
public class ConnectTest {
    ...
    public void handlesUnknownEscapesAcrossBuffer() throws IOException {
        ...
        String url = "https://gist.githubusercontent.com/krystiangorecki/d3bad50ef5615f06b077438607423533/raw/71adfdf81121282ea936510ed6cfe440adeb2d83/JsoupIssue1218.html";
        String localUrl = FileServlet.urlTo(localPath);
        // different chunks meant GH would error but local not...
        Document docFromGithub = Jsoup.connect(url).get();
