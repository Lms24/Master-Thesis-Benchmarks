...
public class AnnotationTest {
    ...
    public void testGoodDataByName() throws FileNotFoundException {
        HeaderColumnNameMappingStrategy<AnnotatedMockBeanFull> strat = new HeaderColumnNameMappingStrategy<AnnotatedMockBeanFull>();
        ...
        HeaderColumnNameMappingStrategy<AnnotatedMockBeanFullDerived> stratd = new HeaderColumnNameMappingStrategy<AnnotatedMockBeanFullDerived>();
    ...
    public void testGoodDataByPosition() throws FileNotFoundException {
        ColumnPositionMappingStrategy<AnnotatedMockBeanFull> strat = new ColumnPositionMappingStrategy<AnnotatedMockBeanFull>();
        strat.setType(AnnotatedMockBeanFull.class);
    ...
    public void testGoodDataCustomByName() throws FileNotFoundException {
        HeaderColumnNameMappingStrategy<AnnotatedMockBeanCustom> strat = new HeaderColumnNameMappingStrategy<AnnotatedMockBeanCustom>();
    ...
    public void testGoodDataCustomByPosition() throws FileNotFoundException {
        ColumnPositionMappingStrategy<AnnotatedMockBeanCustom> strat = new ColumnPositionMappingStrategy<AnnotatedMockBeanCustom>();
        strat.setType(AnnotatedMockBeanCustom.class);
    ...
    public void testCase21() throws FileNotFoundException {
        HeaderColumnNameMappingStrategy<TestCases21And63> strat = new HeaderColumnNameMappingStrategy<TestCases21And63>();
    ...
    public void testCase63() throws FileNotFoundException {
        ColumnPositionMappingStrategy<TestCases21And63> strat = new ColumnPositionMappingStrategy<TestCases21And63>();
        strat.setType(TestCases21And63.class);
    ...
    public void testBadDataByName() throws FileNotFoundException {
        ...
        HeaderColumnNameMappingStrategy<TestCase34> strat34 = new HeaderColumnNameMappingStrategy<TestCase34>();
    ...
    public void testBadConverter() {
        HeaderColumnNameMappingStrategy<TestCase80> strath = new HeaderColumnNameMappingStrategy<TestCase80>();
        try {
        ...
        ColumnPositionMappingStrategy<TestCase80> stratc = new ColumnPositionMappingStrategy<TestCase80>();
        try {
