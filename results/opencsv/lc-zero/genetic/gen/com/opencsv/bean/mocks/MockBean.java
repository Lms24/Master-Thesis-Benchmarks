...
public class MockBean {
    ...
    public boolean equals(Object o) {
        ...
        if (getNum() != mockBean.getNum())
            return false;
        if (Double.compare(mockBean.getDoubleNum(), getDoubleNum()) != 0)
            return false;
        if (getName() != null ? !getName().equals(mockBean.getName()) : mockBean.getName() != null)
            return false;
        if (getId() != null ? !getId().equals(mockBean.getId()) : mockBean.getId() != null)
            return false;
