...
public class IterableCSVToBeanBuilderTest {
    ...
    public void builderWithoutFilter() {
        IterableCSVToBean bean = builder.withMapper(mockMappingStrategy).withReader(mockReader).build();
    ...
    public void builderWithFilter() {
        IterableCSVToBean bean = builder.withMapper(mockMappingStrategy).withReader(mockReader).withFilter(mockFilter).build();
        assertEquals(mockMappingStrategy, builder.getStrategy());
        assertEquals(mockReader, builder.getCsvReader());
